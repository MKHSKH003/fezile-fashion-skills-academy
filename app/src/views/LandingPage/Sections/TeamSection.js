        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={4}>
            <Card plain>
              ...
              <h4 className={classes.cardTitle}>
                ...
                <br />
                <small className={classes.smallTitle}>
                  Integral Part Of Designing The Skills Curriculum
                </small>
              </h4>
              <CardBody>
                <p className={classes.description}>
                  Hlengiwe Shembe is a young energetic soul from Inanda. She has
                  an amazing love for working with the local community in
                  training and Skills Development. She is a DUT Graduate who
          ...
          <GridItem xs={12} sm={12} md={4}>
            <Card plain>
              ...
              <CardBody>
                <p className={classes.description}>
                  Ayanda, our Admin Ninja doing the most to ensure efficiency at
                  the Academy. She is the lady that swiftly responds to all your
                  inquiries regarding courses and end school.
                </p>
              </CardBody>
